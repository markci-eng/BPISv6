...
import { type Document as DocItem } from "../../app/document-management/document-reassignment/(components)/documentsList";
import { Employee as EmployeeModel } from "../../app/document-management/document-reassignment/(components)/employeeSelector";

export const DocumentType = createListCollection({
  items: [
    { label: "ACKNOWLEDGE RECEIPT", value: "acknowledge_receipt" },
    { label: "BANK PAYMENT", value: "bank_payment" },
    { label: "CERTIFICATE OF FULLY PAID", value: "certificate_fully_paid" },
    { label: "CREDIT MEMO", value: "credit_memo" },
    { label: "CREMATION PLAN AGREEMENT", value: "cremation_plan_agreement" },
    { label: "DEBIT MEMO", value: "debit_memo" },
    { label: "FUEL YOUR DRIVE", value: "fuel_your_drive" },
    { label: "PLANHOLDER IDENTIFICATION CARD", value: "planholder_id_card" },
    { label: "LOAN APPLICATION FORM", value: "loan_application_form" },
    { label: "LIFE PLAN AGREEMENT", value: "life_plan_agreement" },
    {
    ...
    { label: "OT", value: "ot" },
    { label: "PLANHOLDER NOTICE", value: "planholder_notice" },
    { label: "LIFE PLAN PLUS AGREEMENT", value: "life_plan_plus_agreement" },
    {
...
export const EMPLOYEES: EmployeeModel[] = [
  {
    ...
    department: "Sales - Zamboanga West",
  },
  {
    id: "ZAMBOA08FC00028",
  ...
  },
  {
    ...
    department: "Sales - Cebu Central",
  },
  {
    id: "DAVAO02FC00054",
    name: "Ronald Bautista",
    department: "Sales - Davao North",
  },
  {
    id: "ILOILO03FC00077",
    name: "Michael Fernandez",
    department: "Sales - Iloilo City",
  },
  {
    id: "BACOLOD04FC00091",
    name: "Patricia Navarro",
    department: "Sales - Bacolod Main",
  },
  {
    id: "CAGAYAN05FC00033",
    name: "Daniel Hernandez",
    department: "Sales - Cagayan De Oro",
  },
];
...
export const DOCUMENTS_BY_EMPLOYEE: Record<string, DocItem[]> = {
  ZAMBOA08FC00027: [
    {
      id: "d1",
